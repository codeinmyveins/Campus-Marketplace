...
function renderImagePreviews() {
    ...
    selectedImages.forEach((img, index) => {
        ...
        wrapper.className = "relative w-40 md:w-4/5 border rounded overflow-hidden";
        ...
        wrapper.innerHTML = `
            <img src="${img.url}" class="w-full h-auto object-cover cursor-pointer transition-transform transform hover:scale-105" onclick="showFullScreenImage('${img.url}')" />
...
function confirmDelete() {
    ...
    // Replace POST_ID with the actual post ID dynamically if available
